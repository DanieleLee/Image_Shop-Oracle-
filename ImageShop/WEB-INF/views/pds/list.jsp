	...
	<c:choose>
		...
		<c:otherwise>
			<c:forEach items="${itemList}" var="item">
				...
				<sec:authorize access="hasRole('ROLE_ADMIN')">
					<td align="center"><a href="modify?itemId=${item.itemId }"><spring:message code="pds.edit" /></a></td>
					<td align="center"><a href="remove?itemId=${item.itemId }"><spring:message code="pds.remove" /></a></td>
				</sec:authorize>
