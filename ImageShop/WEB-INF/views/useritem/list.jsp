...
<table border="1">
	<tr>
		...
		<th align="center" width="100"><spring:message code="useritem.download" /></th>
		...
		<c:otherwise>
			<c:forEach items="${list}" var="useritem">
				<tr>
					...
					<td align="left"><a href="/useritem/read?userItemNo=${useritem.userItemNo}">${useritem.item }</a></td>
					<td align="right">${useritem.price}</td>
					<td align="center"><fmt:formatDate value="${useritem.regDate}" pattern="yyyy-MM-dd HH:mm"/></td>
