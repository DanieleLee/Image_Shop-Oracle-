...
<%@ taglib prefix="spring" uri="http://www.springframework.org/tags" %>
	...
	<table border="1">
		<tr>
			<th align="center" width="160"><spring:message code="codedetail.classCode"/></th>	
			...
			<th align="center" width="160"><spring:message code="codedetail.regdate"/></th>	
	...
	<c:choose>
		...
		<c:otherwise>
			<c:forEach items="${list }" var="codeDetail">
				<tr>
					<td align="center">${codeDetail.classCode }</td>	
					<td align="center">${codeDetail.codeValue }</td>	
					<td align="left"><a href="/codedetail/read?classCode=${codeDetail.classCode }&codeValue=${codeDetail.codeValue}">${codeDetail.codeName}</a></td>	
